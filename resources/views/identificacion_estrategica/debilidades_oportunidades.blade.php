...
<div class="max-w-6xl mx-auto p-6">
    <h1 class="text-2xl font-bold text-gray-800 mb-4">📊 Matriz DO: Debilidades vs Oportunidades</h1>

    <p class="text-gray-600 mb-4">
        Evalúe en qué medida cada debilidad afecta el aprovechamiento de una oportunidad.  
        <br>
    ...
    <form method="POST" action="{{ route('identificacion.guardar.do') }}">
        @csrf
        ...
        <div class="overflow-x-auto border rounded-lg shadow">
            <table class="w-full table-fixed text-sm text-center border-collapse">
                <thead class="bg-blue-100 text-gray-900 uppercase text-xs font-semibold">
                    <tr>
                        <th class="bg-gray-50 text-left px-4 py-2 w-[200px]">Debilidades \ Oportunidades</th>
        ...
        <div class="mt-6 flex justify-end">
            <button type="submit"
                ...
                ➡️ Continuar con Debilidades vs Amenazas
            </button>
        </div>
    </form>
</div>
